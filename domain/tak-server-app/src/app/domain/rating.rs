...
use crate::app::domain::{GameType, PlayerId, game::FinishedGame, game_history::GameRatingInfo};
...
impl RatingService for RatingServiceImpl {
    fn calculate_ratings(
        ...
        if !self.is_game_eligible_for_rating(&game.settings, game.game_type, &result, &game.moves) {
            return None;
        }
